...
const Contact = () => {
  ...
  const handleBlur = (e) => setCurentAnimation('idle');
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: 'richard.petit33800@gmail.com',
        message: form.message
      },
      import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY
    ).then(() => {
      setIsLoading(false);
      showAlert({ show: true, text: 'Le message a bien été envoyé!', type: 'succes' })
      ...
      setIsLoading(false);
      setCurentAnimation('idle');
      showAlert({ show: true, text: "Le message n'a pu être envoyé.", type: 'danger' })
    })
  };
